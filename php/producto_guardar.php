<?php
	...
	if($_FILES['producto_foto']['name']!="" && $_FILES['producto_foto']['size']>0){
		...
		/* Comprobando que la imagen no supere el peso permitido #Aplicar un script para compactar una imagen# */
        ...
        echo '
            <div class="notification is-danger is-light">
                <strong>¡Ocurrio un error inesperado!</strong><br>
                Tipo de archivo no permitido, por favor suba una imagen JPEG o PNG.
            </div>
        ';
        exit();
		...
		$foto=$nombre."_".$producto_codigo.$img_ext;
