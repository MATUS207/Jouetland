<?php
    ...
    /*== Almacenando datos del administrador  34==*/
    ...
    /*== Verificando claves ESTO PUEDEIR EN OTRA VISTA V35==*/
    if($clave_1!="" || $clave_2!=""){
...
if($rol!=$datos['id_rol']){
    ...
    /*== Actualizar datos SE MODIFICARIA  PARA ALA PARTE DE CONTRA  EN OTRA VISTA ==*/
    $actualizar_usuario=conexion();
    $actualizar_usuario=$actualizar_usuario->prepare("UPDATE usuario SET usuario_nombre=:nombre,usuario_apellido=:apellido,usuario_usuario=:usuario,usuario_clave=:clave,usuario_email=:email,id_rol=:rol WHERE usuario_id=:id");
    ...
    if($actualizar_usuario->execute($marcadores)){
        ...
        echo '
            <div class="notification is-danger is-light">
                <strong>¡Ocurrio un error inesperado!</strong><br>
                NO SE PUSO ACTUALIZAR EL USUARIO, POR FAVOR INTENTE NUEVAMENTE
            </div>
        ';
    }
